...
All topic payloads share a common envelope:

```json
{
  "schemaVersion": "1.0",
  "eventType": "telemetry.received",
  "eventId": "evt_1712345678_0",
  ...
  "data": {
    ...
    "nativePayload": { ... },
    "normalized": { "heartRateBpm": 72 }
  }
}
```

The `normalized` block is generated by `App\Domain\EventNormalizer` and provides a vendor-agnostic representation. Examples by feature:

| Feature | normalized keys | Sample value |
|---|---|---|

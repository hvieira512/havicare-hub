...
export function settingRow({
    ...
    // `flex: 1 1 0` na classe, que o Bootstrap não tem: com `flex-grow-1` a base é o conteúdo,
    // e uma descrição de duas linhas não deixava espaço para o botão na mesma linha.
    return html`

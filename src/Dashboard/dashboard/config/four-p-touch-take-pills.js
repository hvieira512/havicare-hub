...
export function takePillsInput(desired, meta = {}) {
    ...
    return `<div class="vstack gap-3">
        ...
        <div class="border rounded p-3 bg-body-tertiary vstack gap-3"><div><div class="fw-semibold">Mensagem do plano</div><div class="small text-secondary">O protocolo 4P Touch aplica o mesmo texto e áudio a todos os horários.</div></div>

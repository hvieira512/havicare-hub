...
final class WatchCapabilityDefinitions
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['deviceType' => 'watch', 'section' => 'telemetry', 'key' => 'call_log', 'label' => 'Call log', 'sortOrder' => 140, 'isTelemetry' => true, 'isConfigurable' => false, 'isRequestable' => false],
            ['deviceType' => 'watch', 'section' => 'telemetry', 'key' => 'sms', 'label' => 'SMS', 'sortOrder' => 150, 'isTelemetry' => true, 'isConfigurable' => false, 'isRequestable' => false],
            ['deviceType' => 'watch', 'section' => 'telemetry', 'key' => 'device_state', 'label' => 'Device state', 'sortOrder' => 160, 'isTelemetry' => true, 'isConfigurable' => false, 'isRequestable' => false],
            ['deviceType' => 'watch', 'section' => 'telemetry', 'key' => 'ecg_analysis', 'label' => 'ECG analysis', 'sortOrder' => 170, 'isTelemetry' => true, 'isConfigurable' => false, 'isRequestable' => false],
            ...
            ['deviceType' => 'watch', 'section' => 'contacts', 'key' => 'phonebook', 'label' => 'Lista telefónica (4P Touch)', 'sortOrder' => 10, 'isTelemetry' => false, 'isConfigurable' => true, 'isRequestable' => false],
            ['deviceType' => 'watch', 'section' => 'settings_system', 'key' => 'push_message', 'label' => 'Push message to watch', 'sortOrder' => 5, 'isTelemetry' => false, 'isConfigurable' => false, 'isRequestable' => true],
            ...
            ['deviceType' => 'watch', 'section' => 'contacts', 'key' => 'whitelist_enabled', 'label' => 'Whitelist enabled', 'sortOrder' => 35, 'isTelemetry' => false, 'isConfigurable' => true, 'isRequestable' => false],
            ...
            ['deviceType' => 'watch', 'section' => 'alarms', 'key' => 'remove_watch_alarm', 'label' => 'Wrist removal alert', 'sortOrder' => 130, 'isTelemetry' => false, 'isConfigurable' => true, 'isRequestable' => false],
            ['deviceType' => 'watch', 'section' => 'alarms', 'key' => 'remove_watch_sms_alert', 'label' => 'Wrist removal SMS alert', 'sortOrder' => 140, 'isTelemetry' => false, 'isConfigurable' => true, 'isRequestable' => false],
            ...
            ['deviceType' => 'watch', 'section' => 'contacts', 'key' => 'call_in_restriction', 'label' => 'Call restriction', 'sortOrder' => 60, 'isTelemetry' => false, 'isConfigurable' => true, 'isRequestable' => false],
            ...
            ['deviceType' => 'watch', 'section' => 'settings_system', 'key' => 'make_call', 'label' => 'Make call', 'sortOrder' => 12, 'isTelemetry' => false, 'isConfigurable' => false, 'isRequestable' => true],
            ['deviceType' => 'watch', 'section' => 'settings_system', 'key' => 'reset_device', 'label' => 'Reset device', 'sortOrder' => 14, 'isTelemetry' => false, 'isConfigurable' => false, 'isRequestable' => true],

...
final class CapabilityCatalog
{
    ...
    public static function telemetryKeysForProtocol(string $protocol): array
    {
        return match ($protocol) {
            ...
            'zayata-m228' => ['battery', 'cells_remaining', 'temperature', 'humidity', 'connectivity', 'tray_lock', 'medication_cup', 'do_not_disturb_state', 'medication_alarm_status', 'firmware_version'],
            default => [],
        };
    }

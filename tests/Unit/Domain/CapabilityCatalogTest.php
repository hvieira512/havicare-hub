...
final class CapabilityCatalogTest extends TestCase
{
    public function testDefinitionsRemainStableAfterBeingSplitByDeviceType(): void
    {
        $expected = [
            ...
            // chamada de ajuda), nove configurações e dez acções. Cada enumeração é uma
            ...
            // perguntam ao aparelho que parâmetros ele serve, uma por família. Duas não estão
            // cá: a reposição de fábrica, que devolvia o aparelho ao servidor do fornecedor, e
            // desligar a cifra, que o fornecedor confirmou que o firmware recusa sempre.
            'pill_dispenser' => [28, '9f9c3ec02794535d19248605ae3605245a44332bc9c32cb4b7d7afce4b0b560e'],
        ];

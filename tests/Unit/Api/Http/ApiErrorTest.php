...
final class ApiErrorTest extends TestCase
{
    ...
    public static function errors(): array
    {
        return [
            ...
            'invalidCredentials' => [fn(): ApiError => ApiError::invalidCredentials(), 'invalid_credentials', 'Invalid credentials', 400],
            'invalidRefreshToken' => [fn(): ApiError => ApiError::invalidRefreshToken(), 'invalid_refresh_token', 'Invalid refresh token', 400],

...
function wonlexCommands(): array
{
    return [
        ...
        ['command' => 'locationInterval', 'title' => 'Set location interval', 'kind' => 'config', 'risk' => 'normal', 'expectedReplyTypes' => ['locationInterval']],
        ['command' => 'deviceConfig', 'title' => 'Set device config', 'kind' => 'config', 'risk' => 'normal', 'expectedReplyTypes' => ['deviceConfig']],
        ['command' => 'alarmClock', 'title' => 'Set alarm clock', 'kind' => 'config', 'risk' => 'normal', 'expectedReplyTypes' => ['alarmClock']],
        ['command' => 'familyNumber', 'title' => 'Set family contacts', 'kind' => 'config', 'risk' => 'normal', 'expectedReplyTypes' => ['familyNumber']],
        ...
        ['command' => 'dnWeather', 'title' => 'Issue weather data', 'kind' => 'data', 'risk' => 'normal', 'expectedReplyTypes' => ['dnWeather']],
        ...
        ['command' => 'restart', 'title' => 'Restart device', 'kind' => 'control', 'risk' => 'high', 'expectedReplyTypes' => ['restart']],
        ['command' => 'powerOff', 'title' => 'Power off device', 'kind' => 'control', 'risk' => 'high', 'expectedReplyTypes' => ['powerOff']],
    ];
}
...
function wonlexUplinks(): array
{
    return [
        ...
        ['command' => 'upBatch', 'origin' => 'scheduled/manual/request', 'features' => ['heart_rate', 'blood_pressure', 'blood_oxygen', 'temperature', 'breath_rate'], 'notes' => 'Batch health upload; dataType identifies the measurement.'],
        ...
        ['command' => 'upWeather', 'origin' => 'device-request', 'features' => ['weather'], 'notes' => 'Requests a dnWeather response from the server.'],
        ['command' => 'upDeviceConfig', 'origin' => 'device-report', 'features' => ['device_config'], 'notes' => 'Reports settings currently held by the device.'],
        ['command' => 'upGetDevConfig', 'origin' => 'device-request', 'features' => [], 'notes' => 'Requests locationInterval, deviceMeasuringFrequency and deviceConfig; it is not telemetry.'],
        ['command' => 'upReset', 'origin' => 'device-control', 'features' => ['device_state'], 'notes' => 'Device-initiated factory reset; server acknowledges the same type.'],
        ['command' => 'upShutdown', 'origin' => 'device-report', 'features' => ['device_state'], 'notes' => 'Reports a device-initiated or low-power shutdown.'],
    ];
}
